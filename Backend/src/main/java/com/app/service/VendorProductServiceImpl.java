...
//		return venProdRepo.findByVendor(vendor);
	...
	@Override
    public ApiResponse deleteVendorProduct(Long vendProdId) {
        VendorProducts venProd = venProdRepo.findById(vendProdId)
                .orElseThrow(() -> new ResourceNotFoundException("Invalid product ID"));
        venProdRepo.delete(venProd);
        return new ApiResponse("Product deleted successfully with ID " + vendProdId);
    }
